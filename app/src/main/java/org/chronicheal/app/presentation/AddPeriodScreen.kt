...
fun AddPeriodScreen(
    ...
    AddEntryScaffold(
        title = if ((id == null) || isNewFromTemplate) stringResource(R.string.log_period) else stringResource(
            R.string.edit_period
        ),
        ...
        Column(
            ...
            Box(
                ...
                IntensityField(
                    ...
                    label = stringResource(R.string.flow_intensity_label)
                )
            }
        }
    }
