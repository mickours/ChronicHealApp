...
@Singleton
class FullLlmManager @Inject constructor(
    @ApplicationContext private val context: Context
) : LlmManager {
    private val tag = "FullLlmManager"
    private val channelId = "ai_model_download"

    override val isAiEnabled: Boolean = true
    ...
    override val isDownloading: StateFlow<Boolean> = _isDownloading
    ...
    override suspend fun downloadModel(): Unit = withContext(Dispatchers.IO) {
    ...
    override suspend fun analyzeMeal(description: String): AiMealAnalysis? =
