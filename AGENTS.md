...
Read these files carefully and propose the next step.
Stop when a feature is complete and propose a git commit message.

**IMPORTANT FOR THE AGENT FOLLOW THESE RULES**:
